package com.yjc.algorithm.sliding_windows;

import com.yjc.algorithm.binary_search.FindDuplicatedNumber;
...
public class FindAllAnagrams {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> result = findAllAnagrams.findAnagrams1(s, p);
